...
$ hdfs dfs -put datasets/retail_logs/access.log /user/hadoop/datasets/retail_logs/
...
CREATE EXTERNAL TABLE tmp_access_logs (
    ...
    LOCATION '/user/hadoop/datasets/retail_logs/';

-- CREAR DIRECTORIO PARA TABLA EXTERNA CON ETL

$ hdfs dfs -mkdir /user/hadoop/warehouse/access_logs_etl
...
CREATE EXTERNAL TABLE etl_access_logs (
    ...
    LOCATION '/user/hadoop/warehouse/access_logs_etl/';
